...
//    Map<String, Double> carrosPopulares2022 = Map.of("gol", 14.4, "uno", 15.6, "mobi", 16.1, "hb20", 14.5, "kwid", 15.6")
    ...
    System.out.println("Confira se o modelo tucson está no dicionário: " + carrosPopulares.containsKey("kwid"));
        ...
        System.out.println("Exiba o dicionário ordenado pelos modelos");
